...
const _Reader = reader.Reader = Reader;
export { _Reader as Reader };
const _BlankException = reader.BlankException = BlankException;
export { _BlankException as BlankException };
const _tokenize = reader.tokenize = tokenize;
export { _tokenize as tokenize };
const _read_form = reader.read_form = read_form;
export { _read_form as read_form };
const _read_str = reader.read_str = read_str;
export { _read_str as read_str };